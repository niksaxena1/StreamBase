  ...
  return (
    <div className="min-h-dvh">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10">
        <div className="sb-accent-glow absolute -left-24 -top-24 h-[520px] w-[520px] opacity-70" />
        <div className="sb-accent-glow absolute -right-40 top-24 h-[560px] w-[560px] opacity-50" />
      </div>

      <div className="mx-auto flex w-full max-w-[1320px] gap-6 px-4 py-6">
        <SideRail />
          ...
          <header className="sb-glass rounded-[28px] px-4 py-3">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="sb-ring grid h-10 w-10 place-items-center rounded-2xl bg-black text-white">
                  <LogoMark />
                </div>
                <div>
              ...
              <div className="flex items-center gap-2">
                <div className="sb-ring h-10 w-10 rounded-full bg-white/70" />
                <div className="sb-ring h-10 w-10 rounded-full bg-white/70" />
              </div>
            </div>
          </header>
