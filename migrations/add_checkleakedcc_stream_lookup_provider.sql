-- Add CheckLeakedCC as a third stream lookup provider.
-- Usage still records one row per day; app code sums the current month to
-- enforce CheckLeakedCC's 1000/month hard limit.
