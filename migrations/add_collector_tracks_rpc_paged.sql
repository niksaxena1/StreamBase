-- Migration: Add paged collector tracks RPC (fix 1000 row cap)
--
-- Supabase/PostgREST often caps API responses at 1000 rows. The UI needs
-- to fetch more than 1000 tracks for some collectors, so we expose a paged
-- RPC that supports offset + limit.
--
-- Usage:
